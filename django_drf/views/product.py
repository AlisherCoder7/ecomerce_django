...
from django_drf.filters import ProductFilter
from django_drf.models import Product
from django_drf.permissions import IsStaffOrReadOnly
from django_drf.serializers import ProductSerializer
